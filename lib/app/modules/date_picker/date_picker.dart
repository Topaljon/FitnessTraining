...
class _DatePickerState extends State<DatePicker> {
      ...
      child: Row(
        ...
        children: [
          ElevatedButton(
            ...
            child: Text('translates.calendar_dialog'.tr
  ...
  Widget _buildDefaultSingleDatePickerWithValue() {
    ...
    return Column(
      ...
      children: [
        ...
        Text('translates.single_date_picker'.tr,
            //'Single Date Picker (With default value)'
        ),
        CalendarDatePicker2(
          config: config,
  ...
  Widget _buildDefaultMultiDatePickerWithValue() {
    ...
    return Column(
      ...
      children: [
        const SizedBox(height: 10),
        Text('translates.multi_date_picke'.tr,
            //'Multi Date Picker (With default value)'
        ),
        CalendarDatePicker2(
          config: config,
  ...
  Widget _buildDefaultRangeDatePickerWithValue() {
    ...
    return Column(
      ...
      children: [
        const SizedBox(height: 10),
        Text('translates.range_date_picker'.tr,
  ...
  Widget _buildCalendarWithActionButtons() {
    ...
    return Column(
      ...
      children: [
        const SizedBox(height: 10),
        Text('translates.date_picker'.tr,
            //'Date Picker With Action Buttons'
        ),
